...
export function TrustSection() {
  return (
    <section className="border-y border-[var(--border)] bg-[var(--card)] py-20 mb-32">
      <div className="max-w-7xl mx-auto px-6">
        <p className="text-center text-sm font-semibold text-[var(--muted)] uppercase tracking-widest mb-12">
          Powered by modern cryptography
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center opacity-90 transition-all duration-500">
